...
<div class="container mt20px">
    <div class="row">
        <div class="col-sm-12"><?php print $breadcrumb; ?></div>
        ...
        <div class="col-md-4 hidden-sm hidden-xs">
            <div class="well cigna-sidebar">
                <?php print render($page['sidebar_cigna_first']); ?>
            </div>
        </div>
        <div class="col-md-4 hidden-sm hidden-xs">
            <div class="well cigna-sidebar">
                <?php print render($page['sidebar_cigna_second']); ?>
            </div>
        </div>
    </div>
</div>
