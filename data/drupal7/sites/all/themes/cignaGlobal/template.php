...
require_once $theme_path . '/functions/menu.php';
require_once $theme_path . '/functions/misc.php';
require_once $theme_path . '/functions/node.php';
require_once $theme_path . '/functions/system.php';
